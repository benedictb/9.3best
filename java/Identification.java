	...
	implements ActionListener
{
	...
	private final String m_strPromptFormat = "    %s, please place your right index finger on the reader\n\n";f
    ...
    public Identification(){
		...
		m_vFingerNames[0] = "Professor Metoyer";
		m_vFingerNames[1] = "Velshonna";
		m_vFingerNames[2] = "Dan";
		m_vFingerNames[3] = "Ben";
		m_vFingerNames[4] = "any enrolled person, ";
...
//					m_text.append(m_strPrompt1);
					String str = String.format(m_strPromptFormat, m_vFingerNames[4]);
					m_text.append(str);
				}
				else{
