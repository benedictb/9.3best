...
//		JButton btnSelect = new JButton("Select reader");
...
//		add(Box.createVerticalStrut(vgap));
//
		JButton btnIdentification = new JButton("Run identification demo");
...
//		add(Box.createVerticalStrut(vgap));
	...
	private static void createAndShowGUI() {
		...
		try{
            ...
            paneContent.m_collection.GetReaders();
            paneContent.m_reader = paneContent.m_collection.get(0);
		}
		...
		//run dialog
		JDialog dlg = new JDialog((JDialog)null, "Rollcall Fingerprint Demo", true);
